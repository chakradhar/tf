...
*/
    ...
    */
   public static final String BUNDLE_JDI_NAME = "com.sun.jdi.Bootstrap";
   
       /**
   * Property to specify name of JDI Bootstrap class.
    */
   public static final String PROPERTY_JDI_BOOTSTRAP = "com.sun.jdi.bootstrap";
   
      /**
    * Property to specify location of jars with JDI implementation.
    */
   public static final String PROPERTY_JDI_LOCATION = "com.sun.jdi.location";
   
       /**
    * Property prefix to specify name of jars with JDI implementation.
    */
   public static final String PROPERTY_JDI_JAR = "com.sun.jdi.jar.";
